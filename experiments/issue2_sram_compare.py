#!/usr/bin/env python3
"""Compare Candidate A and issue-two lane SRAM organizations with HP CACTI."""
...
ISSUE2_RESULTS = ROOT / "analysis_output_issue2_152" / "issue2_lane_study.json"
OUTPUT_PATH = ROOT / "analysis_output_issue2_152" / "issue2_sram_compare.json"
...
def main() -> None:
    ...
    for workload in issue2["workloads"]:
        a_shapes = {"config": (5, workload["issue2_cycles"] - 1)}
        a_shapes.update(
            {
        ...
        workload_organizations[workload["case"]] = {
            ...
            "candidate_a_accesses": {
                "config": workload["issue2_cycles"] - 1,
    ...
    candidate_a_segment_mux_bits = 26 + 26 + 31
    issue2_segment_mux_bits = 34 + 34
