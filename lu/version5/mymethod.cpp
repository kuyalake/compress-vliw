...
void schedule(InstPack** inst, std::vector<int>* ocp[], EleNode* EleNodePointer[], std::vector<OpPack>& pool, int i, std::vector<int>& newly_valid, std::vector<int>& remain_node) {
    for (int j = 0; j < NPE; j++) {
...
void schedule2(InstPack** inst, std::vector<int>* ocp[], EleNode* EleNodePointer[], 
