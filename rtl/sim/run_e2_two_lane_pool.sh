...
#   BERT    : exp2_two_lane_pool_top_bert    + sram_8192x5_wrapper + 2x sram_4096x34_wrapper
#   SD-UNet : exp2_two_lane_pool_top_sd_unet + sram_8192x5_tiled#2 + 2x sram_4096x34_tiled#2
#   LLaMA   : exp2_two_lane_pool_top_llama   + sram_32768x5_wrapper + 2x sram_16384x34_tiled#2
    ...
    case "$sfx" in
        ...
        sd_unet)
            srcs=( "$RTL_DIR/src/sram_8192x5_tiled.v" "$RTL_DIR/src/sram_8192x5_wrapper.v"
                   ...
                   "${M_8192x5[@]}" "${M_4096x34[@]}" ) ;;
        llama)
            srcs=( "$RTL_DIR/src/sram_32768x5_wrapper.v" "$RTL_DIR/src/sram_16384x34_tiled.v"
                   "$RTL_DIR/src/sram_16384x34_wrapper.v"
