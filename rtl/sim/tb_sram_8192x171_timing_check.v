...
module tb_sram_8192x171_timing_check;
    ...
    sram_8192x171_timing_check dut (
        .clk       (clk),
        .rst_n     (rst_n),
        .in_valid  (in_valid),
        .in_write  (in_write),
    ...
    initial begin
        $dumpfile("sram_8192x171_timing_check.vcd");
        $dumpvars(0, tb_sram_8192x171_timing_check);
    end
    ...
    initial begin
        ...
        if (errors == 0 && read_checks == BURST_LEN) begin
            $display("SRAM 8192x171 continuous write/read simulation PASSED at 1GHz.");
        end else begin
            $display("SRAM 8192x171 continuous write/read simulation FAILED, errors=%0d read_checks=%0d.", errors, read_checks);
        end
        $finish;
    end
