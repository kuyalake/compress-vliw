...
# Drives the simple tb (tb_exp4_simple.v) from the repo root.
...
simv="/tmp/exp4_simple.vvp"
"$IV" -g2012 -o "$simv" \
    "$RTL_DIR/sim/tb_exp4_simple.v" \
