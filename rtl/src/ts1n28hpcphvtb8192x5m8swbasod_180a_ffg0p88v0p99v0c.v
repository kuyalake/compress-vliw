...
//*# Library Name   : ts1n28hpcphvtb8192x5m8swbasod (user specify : TS1N28HPCPHVTB8192X5M8SWBASOD)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2026/09/05, 10:52:35										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPHVTB8192X5M8SWBASOD (
            SLP,
            SD,
            CLK, CEB, WEB,
            CEBM, WEBM,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPHVTB8192X5M8SWBASOD_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPHVTB8192X5M8SWBASOD_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 1.9486;
parameter tSLPQ = 1.9486;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.5456;
    ...
    specparam tDS = 0.0874;
    specparam tDH = 0.0392;
    specparam tCD = 0.4979;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.4979;
`else    
    specparam tHOLD = 0.3912;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 7.1047;
    specparam tSDWK2CLK = 7.1047;
    specparam tSD = 0.5456;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.0492;
    specparam tSDQ = 1.9486;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.7307;
    specparam tSLPWK2CLK = 0.7307;
    specparam tSLP = 0.5456;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.0531;
    specparam tSLPQ = 1.9486;
    ...
    specparam tDMS = 0.0874;
    specparam tDMH = 0.0392;
    specparam tBWS = 0.0959;
    specparam tBWH = 0.0365;
    specparam tBWMS = 0.0959;
    specparam tBWMH = 0.0365;


    specparam tAWTQ = 0.1609;
    specparam tAWTQH = 0.1101;
