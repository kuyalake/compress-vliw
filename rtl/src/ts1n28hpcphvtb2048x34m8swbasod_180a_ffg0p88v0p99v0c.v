...
//*# Library Name   : ts1n28hpcphvtb2048x34m8swbasod (user specify : TS1N28HPCPHVTB2048X34M8SWBASOD)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2026/09/05, 20:08:05										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPHVTB2048X34M8SWBASOD (
            SLP,
            SD,
            CLK, CEB, WEB,
            CEBM, WEBM,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPHVTB2048X34M8SWBASOD_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPHVTB2048X34M8SWBASOD_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 0.4265;
parameter tSLPQ = 0.4265;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.4728;
    specparam tCKH = 0.0982;
    specparam tCKL = 0.1704;
    specparam tCS = 0.1325;
    specparam tCH = 0.0379;
    specparam tWS = 0.0717;
    specparam tWH = 0.0390;
    specparam tAS = 0.1105;
    specparam tAH = 0.0403;
    specparam tDS = 0.1000;
    specparam tDH = 0.0334;
    specparam tCD = 0.3855;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.3855;
`else    
    specparam tHOLD = 0.3044;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 6.5696;
    specparam tSDWK2CLK = 6.5696;
    specparam tSD = 0.4728;
    specparam tXSD = 0.1275;
    specparam tSDX = 0.4083;
    specparam tSDQ = 0.4265;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.4227;
    specparam tSLPWK2CLK = 0.4227;
    specparam tSLP = 0.4728;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 0.4065;
    specparam tSLPQ = 0.4265;
    specparam tSLPQH = 0.0000;

    specparam tBISTS = 0.2041;
    specparam tBISTH = 0.0315;
    specparam tCMS = 0.1325;
    specparam tCMH = 0.0379;
    specparam tWMS = 0.0717;
    specparam tWMH = 0.0390;
    specparam tAMS = 0.1105;
    specparam tAMH = 0.0403;
    specparam tDMS = 0.1000;
    specparam tDMH = 0.0334;
    specparam tBWS = 0.1027;
    specparam tBWH = 0.0349;
    specparam tBWMS = 0.1027;
    specparam tBWMH = 0.0349;


    specparam tAWTQ = 0.1941;
    specparam tAWTQH = 0.1283;
    specparam tDQ = 0.2735;
    specparam tDQH = 0.1455;
    specparam tBWEBQ = 0.2735;
    specparam tBWEBQH = 0.1455;
    specparam tDMQ = 0.2735;
    specparam tDMQH = 0.1455;
    specparam tBWEBMQ = 0.2735;
    specparam tBWEBMQH = 0.1455;
