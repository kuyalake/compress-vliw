...
// -----------------------------------------------------------------------------
// E2 two-lane (model-pool): two shared payload lanes for the deep program
// pools (BERT / SD-UNet / LLaMA), max-2 schedule (at most two slots active
