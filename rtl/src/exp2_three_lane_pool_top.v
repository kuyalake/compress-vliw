...
// -----------------------------------------------------------------------------
// E2 three-lane (model-pool): three shared payload lanes for the deep program
// pools (BERT / SD-UNet / LLaMA), max-3 schedule (at most three slots active
...
module exp2_three_lane_pool_top (
    input  wire         clk,
    input  wire         rst_n,
