...
// -----------------------------------------------------------------------------
// Depth-tiled payload SRAM: TILES x sram_16384x34_wrapper -> 34-bit x
// (16384*TILES).  Mechanically derived from sram_4096x34_tiled.v
// (rtl/plan_sram_tiled_wrapper_2026-09-08.md section 4); needed by the E2-2
// (max-2, two-lane) LLaMA-pool lane depth of 32768.
//
...
module sram_16384x34_tiled #(
    parameter TILES  = 2,   // 1, 2, or 4
    parameter ADDR_W = 14 + ((TILES == 4) ? 2 : (TILES == 2) ? 1 : 0),
