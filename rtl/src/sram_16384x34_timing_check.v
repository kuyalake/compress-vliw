...
module sram_16384x34_timing_check (
    input  wire        clk,
    input  wire        rst_n,
    input  wire        in_valid,
    input  wire        in_write,
    input  wire [13:0] in_addr,
    input  wire [33:0] in_wdata,
    input  wire [33:0] in_wmask,
    output reg         out_valid,
    output reg  [33:0] out_rdata
);

    reg        mem_cen_q;
    reg        mem_wen_q;
    reg [13:0] mem_addr_q;
    reg [33:0] mem_wdata_q;
    reg [33:0] mem_wmask_q;
    reg        read_return_q;
