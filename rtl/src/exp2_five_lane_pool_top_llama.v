...
// -----------------------------------------------------------------------------
// E2 five-lane (model-pool): five shared payload lanes for the LLaMA pool,
...
module exp2_five_lane_pool_top_llama (
    input  wire         clk,
    input  wire         rst_n,
    ...
    wire [12:0] lane0_addr = load_en ? load_addr[12:0] : ptr0[12:0];
    wire [12:0] lane1_addr = load_en ? load_addr[12:0] : ptr1[12:0];
    wire [12:0] lane2_addr = load_en ? load_addr[12:0] : ptr2[12:0];
    wire [12:0] lane3_addr = load_en ? load_addr[12:0] : ptr3[12:0];
