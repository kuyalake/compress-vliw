...
// -----------------------------------------------------------------------------
// E2 five-lane (model-pool): five shared payload lanes for the BERT pool,
...
module exp2_five_lane_pool_top_bert (
    input  wire         clk,
    input  wire         rst_n,
    ...
    wire [10:0] lane0_addr = load_en ? load_addr[10:0] : ptr0[10:0];
    wire [10:0] lane1_addr = load_en ? load_addr[10:0] : ptr1[10:0];
    wire [10:0] lane2_addr = load_en ? load_addr[10:0] : ptr2[10:0];
    wire [10:0] lane3_addr = load_en ? load_addr[10:0] : ptr3[10:0];
    wire [10:0] lane4_addr = load_en ? load_addr[10:0] : ptr4[10:0];
