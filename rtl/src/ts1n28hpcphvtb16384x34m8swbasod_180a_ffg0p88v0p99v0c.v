...
//*# Library Name   : ts1n28hpcphvtb16384x34m8swbasod (user specify : TS1N28HPCPHVTB16384X34M8SWBASOD)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2026/09/08, 17:45:54										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPHVTB16384X34M8SWBASOD (
            SLP,
            SD,
            CLK, CEB, WEB,
            CEBM, WEBM,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPHVTB16384X34M8SWBASOD_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPHVTB16384X34M8SWBASOD_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 2.3192;
parameter tSLPQ = 2.3192;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6917;
    specparam tCKH = 0.1120;
    specparam tCKL = 0.1416;
    specparam tCS = 0.1437;
    specparam tCH = 0.0460;
    specparam tWS = 0.0912;
    specparam tWH = 0.0524;
    specparam tAS = 0.1082;
    specparam tAH = 0.0561;
    specparam tDS = 0.0771;
    specparam tDH = 0.0558;
    specparam tCD = 0.6917;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6917;
`else    
    specparam tHOLD = 0.4457;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.4830;
    specparam tSDWK2CLK = 9.4830;
    specparam tSD = 0.6917;
    specparam tXSD = 0.1275;
    specparam tSDX = 2.0765;
    specparam tSDQ = 2.3192;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8697;
    specparam tSLPWK2CLK = 0.8697;
    specparam tSLP = 0.6917;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.0879;
    specparam tSLPQ = 2.3192;
    specparam tSLPQH = 0.0000;

    specparam tBISTS = 0.2093;
    specparam tBISTH = 0.0343;
    specparam tCMS = 0.1437;
    specparam tCMH = 0.0460;
    specparam tWMS = 0.0912;
    specparam tWMH = 0.0524;
    specparam tAMS = 0.1082;
    specparam tAMH = 0.0561;
    specparam tDMS = 0.0771;
    specparam tDMH = 0.0558;
    specparam tBWS = 0.0855;
    specparam tBWH = 0.0536;
    specparam tBWMS = 0.0855;
    specparam tBWMH = 0.0536;


    specparam tAWTQ = 0.1822;
    specparam tAWTQH = 0.1172;
    specparam tDQ = 0.3003;
    specparam tDQH = 0.1221;
    specparam tBWEBQ = 0.3003;
    specparam tBWEBQH = 0.1221;
    specparam tDMQ = 0.3003;
    specparam tDMQH = 0.1221;
    specparam tBWEBMQ = 0.3003;
    specparam tBWEBMQH = 0.1221;
