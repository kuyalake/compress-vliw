...
//*# Library Name   : ts1n28hpcphvtb8192x27m4swbasod (user specify : TS1N28HPCPHVTB8192X27M4SWBASOD)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2026/09/05, 20:09:03										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPHVTB8192X27M4SWBASOD (
            SLP,
            SD,
            CLK, CEB, WEB,
            CEBM, WEBM,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPHVTB8192X27M4SWBASOD_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPHVTB8192X27M4SWBASOD_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 2.3228;
parameter tSLPQ = 2.3228;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6504;
    specparam tCKH = 0.1260;
    specparam tCKL = 0.1419;
    specparam tCS = 0.1453;
    specparam tCH = 0.0387;
    specparam tWS = 0.1166;
    specparam tWH = 0.0486;
    specparam tAS = 0.1166;
    specparam tAH = 0.0527;
    specparam tDS = 0.0809;
    specparam tDH = 0.0454;
    specparam tCD = 0.6267;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6267;
`else    
    specparam tHOLD = 0.3956;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 7.7841;
    specparam tSDWK2CLK = 7.7841;
    specparam tSD = 0.6504;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.9446;
    specparam tSDQ = 2.3228;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9006;
    specparam tSLPWK2CLK = 0.9006;
    specparam tSLP = 0.6504;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.9500;
    specparam tSLPQ = 2.3228;
    specparam tSLPQH = 0.0000;

    specparam tBISTS = 0.2089;
    specparam tBISTH = 0.0315;
    specparam tCMS = 0.1453;
    specparam tCMH = 0.0387;
    specparam tWMS = 0.1166;
    specparam tWMH = 0.0486;
    specparam tAMS = 0.1166;
    specparam tAMH = 0.0527;
    specparam tDMS = 0.0809;
    specparam tDMH = 0.0454;
    specparam tBWS = 0.0925;
    specparam tBWH = 0.0447;
    specparam tBWMS = 0.0925;
    specparam tBWMH = 0.0447;


    specparam tAWTQ = 0.1729;
    specparam tAWTQH = 0.1146;
    specparam tDQ = 0.3053;
    specparam tDQH = 0.1245;
    specparam tBWEBQ = 0.3053;
    specparam tBWEBQH = 0.1245;
    specparam tDMQ = 0.3053;
    specparam tDMQH = 0.1245;
    specparam tBWEBMQ = 0.3053;
    specparam tBWEBMQH = 0.1245;
