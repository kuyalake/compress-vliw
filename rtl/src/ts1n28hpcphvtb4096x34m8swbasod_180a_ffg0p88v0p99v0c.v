...
//*# Library Name   : ts1n28hpcphvtb4096x34m8swbasod (user specify : TS1N28HPCPHVTB4096X34M8SWBASOD)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2026/09/05, 20:08:26										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPHVTB4096X34M8SWBASOD (
            SLP,
            SD,
            CLK, CEB, WEB,
            CEBM, WEBM,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPHVTB4096X34M8SWBASOD_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPHVTB4096X34M8SWBASOD_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 2.1523;
parameter tSLPQ = 2.1523;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6026;
    specparam tCKH = 0.1110;
    specparam tCKL = 0.1527;
    specparam tCS = 0.1437;
    specparam tCH = 0.0454;
    specparam tWS = 0.0912;
    specparam tWH = 0.0517;
    specparam tAS = 0.1082;
    specparam tAH = 0.0554;
    specparam tDS = 0.0772;
    specparam tDH = 0.0553;
    specparam tCD = 0.5177;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5177;
`else    
    specparam tHOLD = 0.4227;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.4424;
    specparam tSDWK2CLK = 9.4424;
    specparam tSD = 0.6026;
    specparam tXSD = 0.1275;
    specparam tSDX = 0.8074;
    specparam tSDQ = 2.1523;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8071;
    specparam tSLPWK2CLK = 0.8071;
    specparam tSLP = 0.6026;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 0.8195;
    specparam tSLPQ = 2.1523;
    specparam tSLPQH = 0.0000;

    specparam tBISTS = 0.2094;
    specparam tBISTH = 0.0335;
    specparam tCMS = 0.1437;
    specparam tCMH = 0.0454;
    specparam tWMS = 0.0912;
    specparam tWMH = 0.0517;
    specparam tAMS = 0.1082;
    specparam tAMH = 0.0554;
    specparam tDMS = 0.0772;
    specparam tDMH = 0.0553;
    specparam tBWS = 0.0856;
    specparam tBWH = 0.0530;
    specparam tBWMS = 0.0856;
    specparam tBWMH = 0.0530;


    specparam tAWTQ = 0.1822;
    specparam tAWTQH = 0.1171;
    specparam tDQ = 0.2984;
    specparam tDQH = 0.1229;
    specparam tBWEBQ = 0.2984;
    specparam tBWEBQH = 0.1229;
    specparam tDMQ = 0.2984;
    specparam tDMQH = 0.1229;
    specparam tBWEBMQ = 0.2984;
    specparam tBWEBMQH = 0.1229;
